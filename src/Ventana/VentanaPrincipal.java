...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    public VentanaPrincipal() {
        ...
        jPanel1.setSize(400,420);
    }
    public void ValidarUsuario(){
        
        contraseña= new String(jPassword1.getPassword());
        if (user.getText().equals("valentina")&&contraseña.compareTo("3687")==0){
            dispose();
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jPassword1, javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSesionActionPerformed
        // TODO add your handling code here:
        contraseña= new String(jPassword1.getPassword());
        if (user.getText().equals("valentina")&&contraseña.compareTo("2323")==0){
            dispose();
            Ventana2 v2= new Ventana2();
            v2.setVisible(true);
        }else{
